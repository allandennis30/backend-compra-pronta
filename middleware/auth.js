...
/**
 * Middleware para verificar e validar JWT token (sem validação de body)
 */
...
/**
 * Middleware para verificar e validar JWT token COM validação de body
 */
const verifyTokenWithValidation = (req, res, next) => {
  try {
